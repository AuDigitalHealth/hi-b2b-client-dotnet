...
namespace Nehta.VendorLibrary.HI
{
    ...
    /// </summary>
    public class ProviderSearchForProviderOrganisationClient : IProviderSearchForProviderOrganisationClient
    {
        ...
        public ProviderSearchForProviderOrganisationClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointUri", endpointUri);
