...
namespace Nehta.VendorLibrary.HI
{
    ...
    /// </summary>
    public class ProviderSearchHIProviderDirectoryForOrganisationClient : IProviderSearchHIProviderDirectoryForOrganisationClient
    {
        ...
        public ProviderSearchHIProviderDirectoryForOrganisationClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointUri", endpointUri);
        ...
        /// </list>
        /// </returns>
        public searchHIProviderDirectoryForOrganisationResponse OpenSearch(searchHIProviderDirectoryForOrganisation request)
        {
            return HISearch(request);
        }
        ...
        /// Asynchronous implementation of <see cref="IdentifierSearch" />.
        /// </summary>
        public async Task<searchHIProviderDirectoryForOrganisationResponse> OpenSearchAsync(searchHIProviderDirectoryForOrganisation request)
        {
            return await HISearchAsync(request);
        }
