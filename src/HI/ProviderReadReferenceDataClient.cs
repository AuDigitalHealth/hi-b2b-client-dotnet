...
namespace Nehta.VendorLibrary.HI
{
    ...
    /// </summary>
    public class ProviderReadReferenceDataClient : IProviderReadReferenceDataClient
    {
        ...
        public ProviderReadReferenceDataClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointUri", endpointUri);
        ...
        /// </summary>
        public async Task<readReferenceDataResponse> ReadReferenceDataAsync(string[] referenceList)
        {
            Validation.ValidateArgumentRequired("referenceList", referenceList);
            ...
            try
            {
                response1 = await providerReadReferenceDataClient.readReferenceDataAsync(envelope);
            }
            catch (Exception ex)
            {
                // Catch generic FaultException and call helper to throw a more specific fault
