...
namespace nehta.mcaR3.ConsumerSearchIHIBatchSync
{
    ...
    public interface ConsumerSearchIHIBatchSyncPortType
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ns.electronichealth.net.au/hi/svc/ConsumerSearchIHIBatchSync/3.0/ConsumerS" +
            "earchIHIBatchSyncPortType/searchIHIBatchSyncRequest", ReplyAction="http://ns.electronichealth.net.au/hi/svc/ConsumerSearchIHIBatchSync/3.0/ConsumerS" +
            "earchIHIBatchSyncPortType/searchIHIBatchSyncResponse")]
        System.Threading.Tasks.Task<nehta.mcaR3.ConsumerSearchIHIBatchSync.searchIHIBatchSyncResponse> searchIHIBatchSyncAsync(nehta.mcaR3.ConsumerSearchIHIBatchSync.searchIHIBatchSyncRequest request);
    }
    ...
    public partial class ConsumerSearchIHIBatchSyncPortTypeClient : System.ServiceModel.ClientBase<nehta.mcaR3.ConsumerSearchIHIBatchSync.ConsumerSearchIHIBatchSyncPortType>, nehta.mcaR3.ConsumerSearchIHIBatchSync.ConsumerSearchIHIBatchSyncPortType
    {
        ...
        public ConsumerSearchIHIBatchSyncPortTypeClient() : 
                base(ConsumerSearchIHIBatchSyncPortTypeClient.GetDefaultBinding(), ConsumerSearchIHIBatchSyncPortTypeClient.GetDefaultEndpointAddress())
        {
            this.Endpoint.Name = EndpointConfiguration.ConsumerSearchIHIBatchSyncSOAP12ServicePort.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ConsumerSearchIHIBatchSyncPortTypeClient(EndpointConfiguration endpointConfiguration) : 
                base(ConsumerSearchIHIBatchSyncPortTypeClient.GetBindingForEndpoint(endpointConfiguration), ConsumerSearchIHIBatchSyncPortTypeClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ConsumerSearchIHIBatchSyncPortTypeClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(ConsumerSearchIHIBatchSyncPortTypeClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ConsumerSearchIHIBatchSyncPortTypeClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(ConsumerSearchIHIBatchSyncPortTypeClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<nehta.mcaR3.ConsumerSearchIHIBatchSync.searchIHIBatchSyncResponse> nehta.mcaR3.ConsumerSearchIHIBatchSync.ConsumerSearchIHIBatchSyncPortType.searchIHIBatchSyncAsync(nehta.mcaR3.ConsumerSearchIHIBatchSync.searchIHIBatchSyncRequest request)
        {
            return base.Channel.searchIHIBatchSyncAsync(request);
        }
        
        public System.Threading.Tasks.Task<nehta.mcaR3.ConsumerSearchIHIBatchSync.searchIHIBatchSyncResponse> searchIHIBatchSyncAsync(nehta.mcaR3.ConsumerSearchIHIBatchSync.ProductType product, nehta.mcaR3.ConsumerSearchIHIBatchSync.SignatureContainerType signature, nehta.mcaR3.ConsumerSearchIHIBatchSync.TimestampType timestamp, nehta.mcaR3.ConsumerSearchIHIBatchSync.QualifiedId user, nehta.mcaR3.ConsumerSearchIHIBatchSync.QualifiedId hpio, nehta.mcaR3.ConsumerSearchIHIBatchSync.SearchIHIRequestType[] searchIHIBatchSync)
        {
            nehta.mcaR3.ConsumerSearchIHIBatchSync.searchIHIBatchSyncRequest inValue = new nehta.mcaR3.ConsumerSearchIHIBatchSync.searchIHIBatchSyncRequest();
            inValue.product = product;
            inValue.signature = signature;
            ...
            inValue.user = user;
            inValue.hpio = hpio;
            inValue.searchIHIBatchSync = searchIHIBatchSync;
            return ((nehta.mcaR3.ConsumerSearchIHIBatchSync.ConsumerSearchIHIBatchSyncPortType)(this)).searchIHIBatchSyncAsync(inValue);
        }
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.ConsumerSearchIHIBatchSyncSOAP12ServicePort))
            {
        ...
        {
            return ConsumerSearchIHIBatchSyncPortTypeClient.GetBindingForEndpoint(EndpointConfiguration.ConsumerSearchIHIBatchSyncSOAP12ServicePort);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return ConsumerSearchIHIBatchSyncPortTypeClient.GetEndpointAddress(EndpointConfiguration.ConsumerSearchIHIBatchSyncSOAP12ServicePort);
        }
        
        public enum EndpointConfiguration
        {
            
            ConsumerSearchIHIBatchSyncSOAP12ServicePort,
        }
    }
}
