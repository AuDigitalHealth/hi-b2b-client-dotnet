...
namespace nehta.mcaR32.ProviderReadProviderOrganisation
{
    ...
    public interface ProviderReadProviderOrganisationPortType
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ns.electronichealth.net.au/hi/svc/ProviderReadProviderOrganisation/3.2.0/P" +
            "roviderReadProviderOrganisationPortType/readProviderOrganisationRequest", ReplyAction="http://ns.electronichealth.net.au/hi/svc/ProviderReadProviderOrganisation/3.2.0/P" +
            "roviderReadProviderOrganisationPortType/readProviderOrganisationResponse")]
        System.Threading.Tasks.Task<nehta.mcaR32.ProviderReadProviderOrganisation.readProviderOrganisationResponse1> readProviderOrganisationAsync(nehta.mcaR32.ProviderReadProviderOrganisation.readProviderOrganisationRequest request);
    }
    ...
    public partial class readProviderOrganisationRequest
    {
        ...
        [System.ServiceModel.MessageHeaderAttribute(Namespace="http://ns.electronichealth.net.au/hi/xsd/common/CommonCoreElements/3.0")]
        public nehta.mcaR32.ProviderReadProviderOrganisation.QualifiedId hpio;
    ...
    public partial class ProviderReadProviderOrganisationPortTypeClient : System.ServiceModel.ClientBase<nehta.mcaR32.ProviderReadProviderOrganisation.ProviderReadProviderOrganisationPortType>, nehta.mcaR32.ProviderReadProviderOrganisation.ProviderReadProviderOrganisationPortType
    {
        ...
        public ProviderReadProviderOrganisationPortTypeClient() : 
                base(ProviderReadProviderOrganisationPortTypeClient.GetDefaultBinding(), ProviderReadProviderOrganisationPortTypeClient.GetDefaultEndpointAddress())
        {
            this.Endpoint.Name = EndpointConfiguration.ProviderReadProviderOrganisationSOAP12Port.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ProviderReadProviderOrganisationPortTypeClient(EndpointConfiguration endpointConfiguration) : 
                base(ProviderReadProviderOrganisationPortTypeClient.GetBindingForEndpoint(endpointConfiguration), ProviderReadProviderOrganisationPortTypeClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ProviderReadProviderOrganisationPortTypeClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(ProviderReadProviderOrganisationPortTypeClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ProviderReadProviderOrganisationPortTypeClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(ProviderReadProviderOrganisationPortTypeClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<nehta.mcaR32.ProviderReadProviderOrganisation.readProviderOrganisationResponse1> nehta.mcaR32.ProviderReadProviderOrganisation.ProviderReadProviderOrganisationPortType.readProviderOrganisationAsync(nehta.mcaR32.ProviderReadProviderOrganisation.readProviderOrganisationRequest request)
        {
            return base.Channel.readProviderOrganisationAsync(request);
        }
        
        public System.Threading.Tasks.Task<nehta.mcaR32.ProviderReadProviderOrganisation.readProviderOrganisationResponse1> readProviderOrganisationAsync(nehta.mcaR32.ProviderReadProviderOrganisation.ProductType product, nehta.mcaR32.ProviderReadProviderOrganisation.SignatureContainerType signature, nehta.mcaR32.ProviderReadProviderOrganisation.TimestampType timestamp, nehta.mcaR32.ProviderReadProviderOrganisation.QualifiedId user, nehta.mcaR32.ProviderReadProviderOrganisation.QualifiedId hpio, nehta.mcaR32.ProviderReadProviderOrganisation.readProviderOrganisation readProviderOrganisation)
        {
            nehta.mcaR32.ProviderReadProviderOrganisation.readProviderOrganisationRequest inValue = new nehta.mcaR32.ProviderReadProviderOrganisation.readProviderOrganisationRequest();
            inValue.product = product;
            inValue.signature = signature;
            ...
            inValue.user = user;
            inValue.hpio = hpio;
            inValue.readProviderOrganisation = readProviderOrganisation;
            return ((nehta.mcaR32.ProviderReadProviderOrganisation.ProviderReadProviderOrganisationPortType)(this)).readProviderOrganisationAsync(inValue);
        }
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.ProviderReadProviderOrganisationSOAP12Port))
            {
        ...
        {
            return ProviderReadProviderOrganisationPortTypeClient.GetBindingForEndpoint(EndpointConfiguration.ProviderReadProviderOrganisationSOAP12Port);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return ProviderReadProviderOrganisationPortTypeClient.GetEndpointAddress(EndpointConfiguration.ProviderReadProviderOrganisationSOAP12Port);
        }
        
        public enum EndpointConfiguration
        {
            
            ProviderReadProviderOrganisationSOAP12Port,
        }
    }
}
