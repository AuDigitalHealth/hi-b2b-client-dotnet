...
namespace nehta.mcaR32.ProviderReadProviderOrganisation
{
    ...
    public interface ProviderReadProviderOrganisationPortType
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ns.electronichealth.net.au/hi/pca/svc/ProviderReadProviderOrganisation/3.2.0/P" +
            "roviderReadProviderOrganisationPortType/readProviderOrganisationRequest", ReplyAction= "http://ns.electronichealth.net.au/hi/pca/svc/ProviderReadProviderOrganisation/3.2.0/P" +
            "roviderReadProviderOrganisationPortType/readProviderOrganisationResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(nehta.mcaR32.ProviderReadProviderOrganisation.ServiceMessagesType), Action= "http://ns.electronichealth.net.au/hi/pca/svc/ProviderReadProviderOrganisation/3.2.0/P" +
