...
namespace nehta.mcaR51.ProviderBatchAsyncSearchForProviderOrganisation
{
    ...
    public partial class SearchForProviderOrganisationBatchAsyncPortTypeClient : System.ServiceModel.ClientBase<nehta.mcaR51.ProviderBatchAsyncSearchForProviderOrganisation.SearchForProviderOrganisationBatchAsyncPortType>, nehta.mcaR51.ProviderBatchAsyncSearchForProviderOrganisation.SearchForProviderOrganisationBatchAsyncPortType
    {
        ...
        public SearchForProviderOrganisationBatchAsyncPortTypeClient() : 
                base(SearchForProviderOrganisationBatchAsyncPortTypeClient.GetDefaultBinding(), SearchForProviderOrganisationBatchAsyncPortTypeClient.GetDefaultEndpointAddress())
        {
            this.Endpoint.Name = EndpointConfiguration.ProviderSearchForIOrganisationBatchAsyncPort.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public SearchForProviderOrganisationBatchAsyncPortTypeClient(EndpointConfiguration endpointConfiguration) : 
                base(SearchForProviderOrganisationBatchAsyncPortTypeClient.GetBindingForEndpoint(endpointConfiguration), SearchForProviderOrganisationBatchAsyncPortTypeClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public SearchForProviderOrganisationBatchAsyncPortTypeClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(SearchForProviderOrganisationBatchAsyncPortTypeClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public SearchForProviderOrganisationBatchAsyncPortTypeClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(SearchForProviderOrganisationBatchAsyncPortTypeClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.ProviderSearchForIOrganisationBatchAsyncPort))
            {
        ...
        {
            return SearchForProviderOrganisationBatchAsyncPortTypeClient.GetBindingForEndpoint(EndpointConfiguration.ProviderSearchForIOrganisationBatchAsyncPort);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return SearchForProviderOrganisationBatchAsyncPortTypeClient.GetEndpointAddress(EndpointConfiguration.ProviderSearchForIOrganisationBatchAsyncPort);
        }
        
        public enum EndpointConfiguration
        {
            
            ProviderSearchForIOrganisationBatchAsyncPort,
        }
    }
}
