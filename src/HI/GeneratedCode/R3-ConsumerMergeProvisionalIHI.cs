...
namespace nehta.mcaR3.ConsumerMergeProvisionalIHI
{
    ...
    public partial class ConsumerMergeProvisionalIHIPortTypeClient : System.ServiceModel.ClientBase<nehta.mcaR3.ConsumerMergeProvisionalIHI.ConsumerMergeProvisionalIHIPortType>, nehta.mcaR3.ConsumerMergeProvisionalIHI.ConsumerMergeProvisionalIHIPortType
    {
        ...
        public ConsumerMergeProvisionalIHIPortTypeClient() : 
                base(ConsumerMergeProvisionalIHIPortTypeClient.GetDefaultBinding(), ConsumerMergeProvisionalIHIPortTypeClient.GetDefaultEndpointAddress())
        {
            this.Endpoint.Name = EndpointConfiguration.ConsumerMergeProvisionalIHISOAP12Port.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ConsumerMergeProvisionalIHIPortTypeClient(EndpointConfiguration endpointConfiguration) : 
                base(ConsumerMergeProvisionalIHIPortTypeClient.GetBindingForEndpoint(endpointConfiguration), ConsumerMergeProvisionalIHIPortTypeClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ConsumerMergeProvisionalIHIPortTypeClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(ConsumerMergeProvisionalIHIPortTypeClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ConsumerMergeProvisionalIHIPortTypeClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(ConsumerMergeProvisionalIHIPortTypeClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.ConsumerMergeProvisionalIHISOAP12Port))
            {
        ...
        {
            return ConsumerMergeProvisionalIHIPortTypeClient.GetBindingForEndpoint(EndpointConfiguration.ConsumerMergeProvisionalIHISOAP12Port);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return ConsumerMergeProvisionalIHIPortTypeClient.GetEndpointAddress(EndpointConfiguration.ConsumerMergeProvisionalIHISOAP12Port);
        }
        
        public enum EndpointConfiguration
        {
            
            ConsumerMergeProvisionalIHISOAP12Port,
        }
    }
}
