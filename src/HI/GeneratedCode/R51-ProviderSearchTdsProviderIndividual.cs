...
namespace nehta.mcaR51.ProviderSearchTdsProviderIndividual
{
    ...
    public partial class ProviderSearchTdsProviderIndividualPortTypeClient : System.ServiceModel.ClientBase<nehta.mcaR51.ProviderSearchTdsProviderIndividual.ProviderSearchTdsProviderIndividualPortType>, nehta.mcaR51.ProviderSearchTdsProviderIndividual.ProviderSearchTdsProviderIndividualPortType
    {
        ...
        public ProviderSearchTdsProviderIndividualPortTypeClient() : 
                base(ProviderSearchTdsProviderIndividualPortTypeClient.GetDefaultBinding(), ProviderSearchTdsProviderIndividualPortTypeClient.GetDefaultEndpointAddress())
        {
            this.Endpoint.Name = EndpointConfiguration.ProviderSearchTdsProviderIndividualPort.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ProviderSearchTdsProviderIndividualPortTypeClient(EndpointConfiguration endpointConfiguration) : 
                base(ProviderSearchTdsProviderIndividualPortTypeClient.GetBindingForEndpoint(endpointConfiguration), ProviderSearchTdsProviderIndividualPortTypeClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ProviderSearchTdsProviderIndividualPortTypeClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(ProviderSearchTdsProviderIndividualPortTypeClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ProviderSearchTdsProviderIndividualPortTypeClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(ProviderSearchTdsProviderIndividualPortTypeClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.ProviderSearchTdsProviderIndividualPort))
            {
        ...
        {
            return ProviderSearchTdsProviderIndividualPortTypeClient.GetBindingForEndpoint(EndpointConfiguration.ProviderSearchTdsProviderIndividualPort);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return ProviderSearchTdsProviderIndividualPortTypeClient.GetEndpointAddress(EndpointConfiguration.ProviderSearchTdsProviderIndividualPort);
        }
        
        public enum EndpointConfiguration
        {
            
            ProviderSearchTdsProviderIndividualPort,
        }
    }
}
