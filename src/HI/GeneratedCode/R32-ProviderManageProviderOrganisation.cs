...
namespace nehta.mcaR32.ProviderManageProviderOrganisation
{
    ...
    public interface ProviderManageProviderOrganisationPortType
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ns.electronichealth.net.au/hi/svc/ProviderManageProviderOrganisation/3.2.0" +
            "/ProviderManageProviderOrganisationPortType/manageProviderOrganisationRequest", ReplyAction="http://ns.electronichealth.net.au/hi/svc/ProviderManageProviderOrganisation/3.2.0" +
            "/ProviderManageProviderOrganisationPortType/manageProviderOrganisationResponse")]
        System.Threading.Tasks.Task<nehta.mcaR32.ProviderManageProviderOrganisation.manageProviderOrganisationResponse1> manageProviderOrganisationAsync(nehta.mcaR32.ProviderManageProviderOrganisation.manageProviderOrganisationRequest request);
    }
    ...
    public partial class manageProviderOrganisationRequest
    {
        ...
        [System.ServiceModel.MessageHeaderAttribute(Namespace="http://ns.electronichealth.net.au/hi/xsd/common/CommonCoreElements/3.0")]
        public nehta.mcaR32.ProviderManageProviderOrganisation.QualifiedId hpio;
    ...
    public partial class ProviderManageProviderOrganisationPortTypeClient : System.ServiceModel.ClientBase<nehta.mcaR32.ProviderManageProviderOrganisation.ProviderManageProviderOrganisationPortType>, nehta.mcaR32.ProviderManageProviderOrganisation.ProviderManageProviderOrganisationPortType
    {
        ...
        public ProviderManageProviderOrganisationPortTypeClient() : 
                base(ProviderManageProviderOrganisationPortTypeClient.GetDefaultBinding(), ProviderManageProviderOrganisationPortTypeClient.GetDefaultEndpointAddress())
        {
            this.Endpoint.Name = EndpointConfiguration.ProviderManageProviderOrganisationSOAP12Port.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ProviderManageProviderOrganisationPortTypeClient(EndpointConfiguration endpointConfiguration) : 
                base(ProviderManageProviderOrganisationPortTypeClient.GetBindingForEndpoint(endpointConfiguration), ProviderManageProviderOrganisationPortTypeClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ProviderManageProviderOrganisationPortTypeClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(ProviderManageProviderOrganisationPortTypeClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ProviderManageProviderOrganisationPortTypeClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(ProviderManageProviderOrganisationPortTypeClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<nehta.mcaR32.ProviderManageProviderOrganisation.manageProviderOrganisationResponse1> nehta.mcaR32.ProviderManageProviderOrganisation.ProviderManageProviderOrganisationPortType.manageProviderOrganisationAsync(nehta.mcaR32.ProviderManageProviderOrganisation.manageProviderOrganisationRequest request)
        {
            return base.Channel.manageProviderOrganisationAsync(request);
        }
        
        public System.Threading.Tasks.Task<nehta.mcaR32.ProviderManageProviderOrganisation.manageProviderOrganisationResponse1> manageProviderOrganisationAsync(nehta.mcaR32.ProviderManageProviderOrganisation.ProductType product, nehta.mcaR32.ProviderManageProviderOrganisation.SignatureContainerType signature, nehta.mcaR32.ProviderManageProviderOrganisation.TimestampType timestamp, nehta.mcaR32.ProviderManageProviderOrganisation.QualifiedId user, nehta.mcaR32.ProviderManageProviderOrganisation.QualifiedId hpio, nehta.mcaR32.ProviderManageProviderOrganisation.manageProviderOrganisation manageProviderOrganisation)
        {
            nehta.mcaR32.ProviderManageProviderOrganisation.manageProviderOrganisationRequest inValue = new nehta.mcaR32.ProviderManageProviderOrganisation.manageProviderOrganisationRequest();
            inValue.product = product;
            inValue.signature = signature;
            ...
            inValue.user = user;
            inValue.hpio = hpio;
            inValue.manageProviderOrganisation = manageProviderOrganisation;
            return ((nehta.mcaR32.ProviderManageProviderOrganisation.ProviderManageProviderOrganisationPortType)(this)).manageProviderOrganisationAsync(inValue);
        }
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.ProviderManageProviderOrganisationSOAP12Port))
            {
        ...
        {
            return ProviderManageProviderOrganisationPortTypeClient.GetBindingForEndpoint(EndpointConfiguration.ProviderManageProviderOrganisationSOAP12Port);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return ProviderManageProviderOrganisationPortTypeClient.GetEndpointAddress(EndpointConfiguration.ProviderManageProviderOrganisationSOAP12Port);
        }
        
        public enum EndpointConfiguration
        {
            
            ProviderManageProviderOrganisationSOAP12Port,
        }
    }
}
