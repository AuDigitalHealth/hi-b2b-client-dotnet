...
namespace Nehta.VendorLibrary.HI.Sample
{
    ...
    class ConsumerSearchIHIBatchSyncClientSample
    {
        ...
        {
            //Set up client
            ConsumerSearchIHIBatchSyncClient client = CreateClient();
        ...
        public async void SampleAsync()
        {
            ...
            {
                // Invokes the batch search
                searchIHIBatchResponse ihiResponse = await client.SearchIHIBatchSyncAsync(searches);
            }
            catch (FaultException fex)
            {
                string returnError = "";
        ...
        public ConsumerSearchIHIBatchSyncClient CreateClient() 
        {
            // ------------------------------------------------------------------------------
            // Set up
            // ------------------------------------------------------------------------------
